...
namespace lopus
{
    ...
    public partial class LOXEntities : DbContext
    {
        private static LOXEntities _context;
        public LOXEntities()
            : base("name=LOXEntities")
        {
        }
        public static LOXEntities GetContext()
        {
            if (_context == null) _context = new LOXEntities();
            return _context;
        }
